        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {ebooks.map((book, index) => (
            ...
            >
              ...
              <div
                className="aspect-[3/4] bg-neutral-100 relative overflow-hidden mb-6 border border-black/10 group-hover:border-black transition-colors shadow-sm cursor-pointer"
                onClick={() => onProductSelect && onProductSelect(book)}
              >
                <img
                  src={book.image}
                  alt={book.name}
              ...
              <div className="flex-grow flex flex-col justify-between">
                <div>
                  <div className="flex justify-between items-start mb-2">
                    <h3
                      className="text-xl font-black uppercase tracking-tight leading-none min-h-[40px] cursor-pointer hover:text-neutral-600 transition-colors"
                      onClick={() => onProductSelect && onProductSelect(book)}
                    >
                      {book.name}
                    </h3>
