...
const items = [
  { id: '01', img: gallery1, alt: 'Hey Skipper field photo 1 — angler on the water' },
  { id: '02', img: gallery2, alt: 'Hey Skipper field photo 2 — saltwater fishing scene' },
  { id: '03', img: gallery3, alt: 'Hey Skipper field photo 3 — catch of the day' },
  { id: '04', img: gallery4, alt: 'Hey Skipper field photo 4 — shoreline fishing setup' },
];
...
const Gallery: React.FC = () => {
  ...
  }, [selectedIndex !== null]); // eslint-disable-line react-hooks/exhaustive-deps
    ...
    <section className="w-full border-b border-black">
      ...
      <div className="border-b border-black p-4 flex justify-between items-center bg-neutral-50">
        ...
        <div className="flex items-center gap-2" aria-hidden="true">
          <div className="w-2 h-2 bg-[#2C5F5F]" />
        ...
        {items.map((item, index) => (
          <motion.button
            ...
            className={`
              ...
              group overflow-hidden cursor-zoom-in text-left w-full
            `}
          >
            {/* Image Layer */}
            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-between z-10 pointer-events-none">
              ...
              <div className="flex justify-between items-start">
                <span className="font-mono text-xs bg-black text-white px-2 py-1" aria-hidden="true">IMG_{item.id}</span>
                <Plus className="w-6 h-6 text-white opacity-50 group-hover:opacity-100 transition-all duration-500 rotate-0 group-hover:rotate-90" strokeWidth={1} aria-hidden="true" />
              </div>
      ...
      <AnimatePresence>
        {selectedIndex !== null && (
          <motion.div
            role="dialog"
            aria-modal="true"
            aria-label={selectedIndex !== null ? items[selectedIndex].alt : 'Photo gallery'}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          >
            ...
            <button
              ...
              onClick={() => setSelectedIndex(null)}
            >
              <X className="w-8 h-8 md:w-10 md:h-10" strokeWidth={1} aria-hidden="true" />
            </button>
            ...
            <button
              ...
              onClick={handlePrev}
            >
              <ChevronLeft className="w-8 h-8 md:w-12 md:h-12" strokeWidth={1} aria-hidden="true" />
            </button>
            <button
              ...
              onClick={handleNext}
            >
              <ChevronRight className="w-8 h-8 md:w-12 md:h-12" strokeWidth={1} aria-hidden="true" />
            </button>
