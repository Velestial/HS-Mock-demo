...
<div className="flex-grow flex flex-col justify-between relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 w-full border-b border-black">
          <div className="p-4 border-r border-black flex flex-col">
            <span className="text-xs font-mono uppercase text-neutral-500">Model</span>
            <span className="text-sm font-bold uppercase">9'2" Hybrid Travel</span>
          </div>
          <div className="p-4 md:border-r border-black flex flex-col border-b md:border-b-0">
            <span className="text-xs font-mono uppercase text-neutral-500">Weight</span>
            <span className="text-sm font-bold uppercase">5.2 oz / 147g</span>
          </div>
          <div className="p-4 border-r border-black flex flex-col">
            <span className="text-xs font-mono uppercase text-neutral-500">Material</span>
            <span className="text-sm font-bold uppercase">Toray Carbon</span>
          </div>
          <div className="p-4 flex flex-col">
            <span className="text-xs font-mono uppercase text-neutral-500">Status</span>
            <span className="text-sm font-bold uppercase flex items-center gap-2">
              <span className="w-2 h-2 bg-[#2C5F5F]" aria-hidden="true" /> In Stock
            </span>
          </div>
        </div>
        ...
        <div className="w-full border-t border-black grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center p-8 md:p-12 items-start md:items-end">
            <motion.button
              ...
              className="group relative w-full md:w-auto overflow-hidden bg-[#2C5F5F] text-white px-12 py-6 text-xl font-bold uppercase tracking-widest transition-all hover:bg-[#1f4444]"
            >
            ...
            <div className="mt-4 flex items-center gap-3">
              ...
              <span className="font-mono text-xs font-bold uppercase tracking-wide">
                <span className="sr-only">Rated 4.8 out of 5 stars.</span>
                <span aria-hidden="true">4.8 <span className="text-neutral-400 mx-1">/</span> 51 Reviews</span>
              </span>
            </div>
          </div>
        </div>
